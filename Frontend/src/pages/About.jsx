  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row mb-20">
        ...
        <div className="border border-gray-200 px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-[#5f6fff] hover:text-white transition-all duration-300 cursor-pointer text-gray-600">
          <b>CONVENIENCE:</b>
          <p>
